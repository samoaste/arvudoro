...
const STRINGS = {
  en: {
    ...
    nextBreak: 'Next break', nextCircuit: 'Next long break: circuit of {n}',
    timer: 'Timer', stats: 'Stats', settings: 'Settings',
    sets: '{sets} × {amount}', reps: 'reps', secs: 's', perSide: 'each side',
    setDone: 'Set done', startSet: 'Start set', swap: 'Swap', setOf: 'Set {n} of {total}',
    allDone: 'Done! Breathe and rest until the break ends.',
    circuitStep: 'Exercise {n} of {total}', nextUp: 'Next',
    ...
    sAbout: 'About',
    aboutText: 'Pomodoro timer with active breaks: every pause is a compound exercise you can do with dumbbells, a pull-up bar, a jump rope or your own body.',
  ...
  pt: {
    ...
    nextBreak: 'Próxima pausa', nextCircuit: 'Próxima pausa longa: circuito de {n}',
    timer: 'Timer', stats: 'Estatísticas', settings: 'Ajustes',
    sets: '{sets} × {amount}', reps: 'reps', secs: 's', perSide: 'cada lado',
    setDone: 'Série feita', startSet: 'Iniciar série', swap: 'Trocar', setOf: 'Série {n} de {total}',
    allDone: 'Pronto! Respire e descanse até a pausa acabar.',
    circuitStep: 'Exercício {n} de {total}', nextUp: 'Próximo',
    ...
    sAbout: 'Sobre',
    aboutText: 'Timer pomodoro com pausas ativas: cada pausa é um exercício composto que você faz com halteres, barra fixa, corda de pular ou o próprio corpo.',
