...
Each break brings one compound exercise, animated step by step, that you can
do with dumbbells, a pull-up bar, a jump rope or just your body. Long breaks
become a short circuit. Free and open source, by [Arvucore](https://github.com/samoaste).
...
<p align="center">
  <img src="docs/screenshots/timer.png" width="240" alt="Focus timer">
  <img src="docs/screenshots/break.png" width="240" alt="Break with an exercise">
...
restart phase · <kbd>Enter</kbd> set done · <kbd>Ctrl</kbd>+<kbd>1</kbd>/<kbd>2</kbd>/<kbd>,</kbd>
